...
namespace ClassExplorer
{
	public class person
	{
		...
		{
			get { return _userID; } 
			set { _userID = value; } //VALUE се взима от попълнените PROPERTIES
		}
		public string userFName 
		{
			get { return _userFName; }
			set { _userFName = value; } //VALUE се взима от попълнените PROPERTIES
		}
		public string userLName 
		{
			get { return _userLName; }
			set { _userLName = value; } //VALUE се взима от попълнените PROPERTIES
		}
